...
import game4Guide from '../assets/guide/game4Guide.png';
  ...
  return (
    <Modal
      ...
      <div className="GuideModal-page">
        ...
        <section className="GuideModal-page__section">
          <p className="GuideModal-page__section--header">- 동화 완성하기</p>
          <p className="GuideModal-page__section--text">4. 문장을 읽고 빈칸에 들어갈 단어를 고르세요!</p>
          <img
            src={game4Guide}
            alt="게임 설명"
            className="GuideModal-page__image"
