...
import game2Guide from '../assets/guide/game2Guide.png';
  ...
  return (
    <Modal
      ...
      <div className="GuideModal-page">
        ...
        <section className="GuideModal-page__section">
          <p className="GuideModal-page__section--header">- 녹음 하기</p>
          <p className="GuideModal-page__section--text">4. 녹음 버튼을 누르고 단어를 말하세요.</p>
          <img
            src={game2Guide}
            alt="게임 설명"
            className="GuideModal-page__image"
