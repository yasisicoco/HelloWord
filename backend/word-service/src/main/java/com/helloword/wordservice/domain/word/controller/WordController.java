...
public class WordController {
    ...
    @PostMapping("/details")
    public ResponseEntity<List<Word>> getWordDetails(@RequestBody List<Long> wordIds) {
    ...
    public ResponseEntity<List<Word>> getWordDetailsBykidIds(@PathVariable Long kidId) {
